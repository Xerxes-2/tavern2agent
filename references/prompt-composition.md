...
- 模型可见文本（身份声明、tool label、玩家面板）不出现工程脚手架措辞：sandbox/framework/沙盒这类词换成世界内/叙事措辞（例：sandbox → directed-narrative engine，并点明「paced, GM-driven story system, not a free-roam world simulation」）。内部包名/目录/tool id/开发文档不动。
